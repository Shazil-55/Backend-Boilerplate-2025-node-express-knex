...
export class AuthDatabase {
  ...
  async DeleteSession(where: Partial<Entities.verifySession>): Promise<void> {
  ...
  async GetSession(where: Partial<Entities.verifySession>): Promise<Entities.verifySession | undefined> {
  ...
  async StoreSessionToken(data: Partial<Entities.verifySession>): Promise<void> {
